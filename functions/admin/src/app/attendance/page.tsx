...
export default function AttendancePage() {
  ...
  const getDisplayStatus = (record: any): "present" | "absent" | "half_day" | "late" | "early_leave" | "on_leave" | "pending" => {
    ...
    // Absent - if auto-generated (not finalized yet), show as pending
    if (!hasCheckIn && record.status === "absent") {
      return record.isAutoGenerated ? "pending" : "absent";
    }

    // Half day - if auto-generated, show as pending
    if (record.status === "half_day") {
      return record.isAutoGenerated ? "pending" : "half_day";
    }
      ...
      <DashboardLayout>
        <div className="flex flex-col gap-6 p-6">
          ...
          <AttendanceTable
            ...
            onEdit={handleEdit}
            onExportRecord={(record) => { /* TODO: Implement export */ }}
          />
